...
find ./ -type f ! -path "./node_modules/*" ! -path "./.output/server/node_modules/*" -exec sed -i "s/BUILDTEMPLATE-NUXT-SITE-URL/${NUXT_SITE_URL//\//\\/}/g" {} \;
...
find ./ -type f ! -path "./node_modules/*" ! -path "./.output/server/node_modules/*" -exec sed -i "s/BUILDTEMPLATE-SITE-FB-PIXEL/${SITE_VK_PIXEL//\//\\/}/g" {} \;
